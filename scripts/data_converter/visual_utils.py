...
import numpy as np
# rope3d
color_map = {"Car":(0, 255, 0), "Bus":(0, 255, 255), "Pedestrian":(255, 255, 0), "Cyclist":(0, 0, 255), "Trafficcone":(255,0,0)}
color_map_eval  = {"Car":(0, 125, 125), "Bus":(111, 111, 111), "Pedestrian":(55, 55, 0), "Cyclist":(200, 50, 0), "Trafficcone":(255,0,0)}
# dair-v2x-kitti 
# color_map = {"Car":(0,255,0), "Trafficcone":(0,255,255), "Cyclist":(0,0,255), "Pedestrian":(255,255,0)}
...
def draw_3d_box_on_image(image, label_2_file, P2, denorm, c=(0, 255, 0), gt = True):
    with open(label_2_file) as f:
      for line in f.readlines():
          line_list = line.split('\n')[0].split(' ')
          object_type = line_list[0]
          if object_type =="Trafficcone":
             continue
